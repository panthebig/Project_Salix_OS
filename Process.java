...
public class Process {
    ...
    public void run() {
        ...
        //ousiastika se auta kalw to setState kai analogws to vazw sto antistoixo state
        pcb.setState(ProcessState.RUNNING,theTime);

        int n=0; //o xronos pou tha treksei gia auto to instance
        ArrayList runTimes = new ArrayList<Integer>();
        runTimes=pcb.getStartTimes();
    }
